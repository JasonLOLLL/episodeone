...
public class SpongebobSlamGoal extends BaseSpongebobGoal {
    public SpongebobSlamGoal(SpongebobBossEntity spongebob) {
        super(spongebob, 80, 100, 116234512311234515.0F);
